    ...
    <div className="w-full flex justify-center mb-4">
      ...
      <div className="hidden md:flex bg-card-warm border-4 border-black rounded-2xl overflow-hidden shadow-card">
        {LOCATIONS.map((loc) => (
          <button
            ...
            className={`px-5 py-2 font-medium border-r-4 border-black last:border-r-0 ${typography.textParagraph}
              ${value === loc
      ...
      <div className="w-full max-w-xs flex md:hidden relative">
        <select
          ...
          className={`block w-full py-2 px-4 rounded-xl border-4 border-black text-tennis-green font-medium bg-card-warm shadow-card appearance-none ${typography.textParagraph}`}
          value={value}
