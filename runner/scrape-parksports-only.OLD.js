...
(async () => {
  ...
  try {
    ...
    // 🗄️ No pre-scraping cleanup - slots will be cleared at the end of each successful scrape
    console.log('🗄️ Starting ParkSports scraping (old slots will be cleared after each successful scrape)...');
